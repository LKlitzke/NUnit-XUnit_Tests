...
namespace Bongo.Web
{
    ...
    public class RoomBookingControllerTests
    {
        ...
        [Test]
        public void BookStudyRoom_NotSuccessful_NoRoomCode()
        {
        ...
        [Test]
        public void BookStudyRoom_Successful_SuccessfulCodeAndRedirect()
        {
            // Arrange
            _studyRoomBookingService.Setup(x => x.BookStudyRoom(It.IsAny<StudyRoomBooking>()))
            ...
            Assert.AreEqual("Lucas", actionResult.RouteValues["FirstName"]);
